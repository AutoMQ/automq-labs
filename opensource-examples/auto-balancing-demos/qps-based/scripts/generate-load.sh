#!/bin/bash
# Generate qps imbalance by sending high-volume qps to specific partitions
...
# Configuration
TOPIC="qps-test"
RECORD_SIZE=16  # 16 bytes for high QPS
NUM_RECORDS=500000
...
echo "This will create qps imbalance by sending most qps to broker 0"
echo ""
...
echo "Most qps should now be going to broker 0 (server1)."
echo ""
echo "Next steps:"
