...
**✅ Recommended: Run the complete demo script**
...
1. Start the Docker cluster with Prometheus and Grafana
2. Create the topic with imbalanced distribution (4-1-1)
3. Generate traffic load (10 MB/sec)
4. Monitor for auto-balancing (checks every 30s)
5. Capture screenshots at key moments (before, during, after)
6. Generate detailed logs and metrics
7. Display final results

**Duration**: ~25 minutes

**Results**: All logs and screenshots saved to `results/` directory
