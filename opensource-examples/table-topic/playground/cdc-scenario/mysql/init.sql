...
-- Demo CDC Operations: DELETE
DELETE FROM users WHERE first_name = 'CDC' AND last_name = 'Test2';

-- Demo Schema Evolution: ADD COLUMN
...
-- Demo Schema Evolution: DROP COLUMN
ALTER TABLE users DROP COLUMN age;

-- Demo Schema Evolution: MODIFY COLUMN
