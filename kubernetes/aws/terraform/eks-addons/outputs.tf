output "cluster_autoscaler_role_arn" {
  ...
  value       = var.enable_autoscaler ? module.cluster_autoscaler_irsa_role[0].iam_role_arn : null
}

output "alb_controller_role_arn" {
  description = "ARN of the ALB Controller IAM role"
  value       = var.enable_alb_ingress_controller ? module.lb_irsa_role[0].iam_role_arn : null
}

output "ebs_csi_role_arn" {
  description = "ARN of the EBS CSI IAM role"
  value       = var.enable_ebs_csi_driver ? module.ebs-csi-irsa-role[0].iam_role_arn : null
}
