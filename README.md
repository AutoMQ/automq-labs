...
*   **[Table Topic](opensource-examples/table-topic/)**: Explore solutions for append and CDC scenarios with Table Topic, and integrations with Iceberg REST Catalog, AWS Glue, and Hive Metastore. Includes a playground with multiple scenarios.
